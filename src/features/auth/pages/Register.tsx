...
import { Country, RegisterFormData } from "@/features/auth/types";
...
export const RegisterPage: React.FC = () => {
  (RegisterPage as any).tag = "Register Page";
  ...
  const onSubmit = async (userData: RegisterFormData) => {
    ...
    const { data, message, success } = await RequestInterceptor.handleRequest(
      () =>
        register({
          ...userData,
      ...
      <div className="flex shadow-xl rounded-lg">
        <div className="flex-1 rounded-l-lg bg-primary flex-col justify-center items-center text-white sm:flex hidden">
          ...
          <p className="text-center max-w-md px-4">
            Welcome to Learnoso, please enter the required details to create an
        ...
        <div className="flex-1 flex flex-col justify-center py-6 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white rounded-r-lg">
